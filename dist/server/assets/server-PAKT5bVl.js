...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CKDZwPbQ.js");
...
const manifest = {
  "61fa2bd978a7dec1959aaf623d300b8d3cd1c7b1a78dccc703d535116293a18a": {
    functionName: "resendChatTranscript_createServerFn_handler",
    importer: () => import("./chat-admin.functions-BnxV3Ryx.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C2_rbkH8.js").then((n) => n.r),
    import("./start-CFt7blUV.js"),
